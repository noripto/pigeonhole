...
const en = {
  ...
  defaultsAdded: "Added three example attributes. Edit or delete them in the settings.",
...
const ja: typeof en = {
  ...
  setApiKeyDesc: "JevのAPIキーを取得する必要があります。",
  ...
  defaultsAdded: "例として属性を3件用意しました。設定で変更・削除できます。",
  children: "子属性",
